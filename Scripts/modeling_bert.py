...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
      ...
      #  print(str(position_ids))
      #  print("this is input ids: " + str(input_ids))
      ...
      #  print("this is input embeddings: " + str(inputs_embeds))
      #  print("this are position ids" + str(position_ids))
...
class BertForLongSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        if(input_ids.shape[0] == 4):
            ...
            batch_size = input_ids.shape[0]
       # print("this is length of input ids before view: " + str(len(input_ids[0])))
        input_ids = input_ids.view(self.split*batch_size, 512)
      #  print("this is input ids shape" + str(input_ids.shape))
        if(attention_mask is not None):
            attention_mask = attention_mask.view(self.split*batch_size, 512)
        token_type_ids = None
      #  print("this is position ids directly after input view: " + str(position_ids))       
